...
void setup()
{
  ...
  if (!HARDCODE_CALIBRATION) {
    //run a few hundred times if you want to actually calibrate it manually
    ...
    qtrrc.calibrate(); // calibrate once to set up arrays
    qtrrc.calibratedMinimumOn[0] = 280;
    qtrrc.calibratedMinimumOn[1] = 224;
    qtrrc.calibratedMinimumOn[2] = 220;
    qtrrc.calibratedMinimumOn[3] = 224;
    qtrrc.calibratedMinimumOn[4] = 168;
    qtrrc.calibratedMinimumOn[5] = 168;
    qtrrc.calibratedMinimumOn[6] = 168;
    qtrrc.calibratedMinimumOn[7] = 168;
