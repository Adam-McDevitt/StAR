...
FOLLOW_FRONT_DEPOSIT = 14  # until next junction
FOLLOW_RIGHT_DEPOSIT = 15  # until next junction
FOLLOW_BACK_DEPOSIT = 16  # until next junction
...
FROM_VAN_PLACE_AND_RETURN[1] = [SET_HEIGHT_LOWER_SHELF, FOLLOW_FRONT_DEPOSIT, FOLLOW_FRONT_DEPOSIT, DROP,FOLLOW_BACK_DEPOSIT, FOLLOW_BACK_DEPOSIT]
FROM_VAN_PLACE_AND_RETURN[2] = [SET_HEIGHT_ON_BOX, FOLLOW_FRONT_DEPOSIT, FOLLOW_FRONT_DEPOSIT, DROP, FOLLOW_BACK_DEPOSIT, FOLLOW_BACK_DEPOSIT]
FROM_VAN_PLACE_AND_RETURN[3] = [SET_HEIGHT_LOWER_SHELF, FOLLOW_FRONT_DEPOSIT, DROP, FOLLOW_BACK_DEPOSIT]
FROM_VAN_PLACE_AND_RETURN[4] = [SET_HEIGHT_ON_BOX, FOLLOW_FRONT_DEPOSIT, DROP, FOLLOW_BACK_DEPOSIT]
FROM_VAN_PLACE_AND_RETURN[5] = [SET_HEIGHT_LOWER_SHELF, DROP]
