...
FROM_VAN_PLACE_AND_RETURN[1] = [SET_HEIGHT_LOWER_SHELF, FOLLOW_FRONT, FOLLOW_FRONT, DROP, FOLLOW_BACK, FOLLOW_BACK]
FROM_VAN_PLACE_AND_RETURN[2] = [SET_HEIGHT_ON_BOX, FOLLOW_FRONT, FOLLOW_FRONT, DROP, FOLLOW_BACK, FOLLOW_BACK]
FROM_VAN_PLACE_AND_RETURN[3] = [SET_HEIGHT_LOWER_SHELF, FOLLOW_FRONT, DROP, FOLLOW_BACK]
